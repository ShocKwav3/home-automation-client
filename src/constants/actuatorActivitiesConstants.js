export const actuatorActivitiesConstants = {
  ...
  GET_ACTUATOR_ACTIVITIES_ALL_FAILURE: 'actuatorActivities/all/GET_FAILURE',

  ACTUATOR_ACTIVITIES_SINGLE_REALTIME_UPDATE: 'actuatorActivities/single/REALTIME_UPDATE',
}